...
func (r *SegmentManager) Sweep(ctx context.Context, body api.RESTDeleteWebhooksBody) (api.RESTDeleteSegmentsData, error) {
	var out api.RESTDeleteSegmentsData
	err := r.Rest.DeleteWithBody(ctx, api.Routes.Segments.Sweep(), body, &out, nil)
	return out, err
}
...
func (r *SegmentManager) AttachContacts(ctx context.Context, id string, body api.RESTPostAttachSegmentContactsBody) (api.RESTPostAttachSegmentContactsData, error) {
	var out api.RESTPostAttachSegmentContactsData
	err := r.Rest.Post(ctx, api.Routes.Segments.Contacts.AttachMany(id), body, &out, nil)
	return out, err
}

func (r *SegmentManager) DetachContacts(ctx context.Context, id string, body api.RESTPostDetachSegmentContactsBody) (api.RESTPostDetachSegmentContactsData, error) {
	var out api.RESTPostDetachSegmentContactsData
	err := r.Rest.Post(ctx, api.Routes.Segments.Contacts.DetachMany(id), body, &out, nil)
	return out, err
}
